...
import submitEmployee from "@/Helpers/submitData";
...
const AddEmployeeForm = () => {
  ...
  // Function to check if the image type is either png or jpg/jpeg
 

  // Function to validate the phone number (supports optional country code and 10-15 digits)
  ...
  const handleSubmit = async (e) => {
    ...
    submitEmployee(employeeData, toast, setToast);
